...
作战室的公务员 / 选调时间节点核实于 2026-08-29（见「官方信息入口」）；岗位雷达数据最近一轮核实于 **2026-09-16**（新增 5 家公司 / 15 条岗位），逐条核实日期见 `jobs.json` 的 `last_verified_at`（范围 2026-09-01 ~ 2026-09-16）。投递前务必以各公司官网为准。
